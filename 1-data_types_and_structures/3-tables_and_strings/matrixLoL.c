...
int main () {
    ...
    fiora_m = (matrix[0][0]+matrix[0][1]+matrix[0][2]+matrix[0][3]+matrix[0][4])/5;
    irelia_m = (matrix[1][0]+matrix[1][1]+matrix[1][2]+matrix[1][3]+matrix[1][4])/5;
    jax_m = (matrix[2][0]+matrix[2][1]+matrix[2][2]+matrix[2][3]+matrix[2][4])/5;
